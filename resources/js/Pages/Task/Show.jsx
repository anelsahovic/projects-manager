      ...
      <div className="py-12">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
            <div>
              <img src={task.image_path} className="object-cover w-full h-64" />
            </div>
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <div className="overflow-auto">
                <div className="py-2 my-2 text-center border-b-2 border-gray-500">
                  <label className="text-lg font-bold"> Project Name</label>
                  <Link href={route("project.show", task.project.id)}>
                    <p className="mt-1 hover:underline">{task.project.name}</p>
                  </Link>
                </div>
                <div>
                ...
                <div className="mt-4 border-t-2 border-gray-500">
                  <label className="mt-4 text-lg font-bold">
                    Task Description
                  </label>
